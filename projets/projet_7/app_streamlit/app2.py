...
# Utiliser des variables de session pour stocker l'état des variables sélectionnées et le mode d'affichage
if 'display_mode' not in st.session_state:
    st.session_state.display_mode = "far_from_median"

if st.session_state.display_mode == "far_from_median":
    selected_variables = far_from_median[:n_variables]
else:
    selected_variables = top_variables[:n_variables]
